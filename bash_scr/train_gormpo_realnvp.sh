...
python mopo.py --config configs/realnvp/gormpo_halfcheetah_medium_replay.yaml --devid 3
echo "✓ HalfCheetah GORMPO-RealNVP training complete"
echo ""
echo ">>> Training GORMPO on Hopper-Medium-Replay-v2..."
python mopo.py --config configs/realnvp/gormpo_hopper_medium_replay.yaml --devid 3
echo "✓ Hopper GORMPO-RealNVP training complete"
echo ""
echo ">>> Training GORMPO on Walker2d-Medium-Replay-v2..."
python mopo.py --config configs/realnvp/gormpo_walker2d_medium_replay.yaml --devid 3
