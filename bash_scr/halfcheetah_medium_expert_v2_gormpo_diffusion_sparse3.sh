...
echo "============================================"
echo ""
RESULTS_FILE="results/hyperparameter/halfcheetah-medium-expert-sparse/gormpo_diffusion_multilambda_results.csv"
...
python helpers/normalizer.py $RESULTS_FILE halfcheetah-medium-expert-v2_file 