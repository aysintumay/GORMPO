...
python mopo.py --config configs/kde/gormpo_halfcheetah_medium_replay.yaml --devid 3
echo "✓ HalfCheetah GORMPO-KDE training complete"
echo ""
echo ">>> Training GORMPO on Hopper-Medium-Replay-v2..."
python mopo.py --config configs/kde/gormpo_hopper_medium_replay.yaml --devid 3
echo "✓ Hopper GORMPO-KDE training complete"
echo ""
echo ">>> Training GORMPO on Walker2d-Medium-Replay-v2..."
python mopo.py --config configs/kde/gormpo_walker2d_medium_replay.yaml --devid 3
