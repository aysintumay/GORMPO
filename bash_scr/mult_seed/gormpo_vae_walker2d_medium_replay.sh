#!/bin/bash
# Multi-seed GORMPO-VAE training for Walker2d-Medium-Replay-v2
# Usage: bash bash_scr/mult_seed/gormpo_vae_walker2d_medium_replay.sh
...
echo "============================================"
echo "Multi-Seed GORMPO-VAE Training: Walker2d-Medium-Replay"
echo "============================================"
echo ""
...
RESULTS_FILE="results/walker2d-medium-replay/vae/gormpo_vae_multiseed_results.csv"
...
for seed in "${seeds[@]}"; do
    ...
    python vae_module/vae.py \
        --config configs/vae/walker2d_medium_replay.yaml \
        --seed $seed \
        --model_save_path /public/gormpo/models/walker2d_medium_replay/vae_$seed \
        --device cuda:2
    ...
    python mopo.py \
        --config configs/vae/gormpo_walker2d_medium_replay.yaml \
        --seed $seed \
        --classifier_model_name /public/gormpo/models/walker2d_medium_replay/vae_$seed \
        --epoch 1000 \
        --devid 2 \
