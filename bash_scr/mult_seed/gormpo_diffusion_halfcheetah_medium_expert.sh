...
echo "============================================"
echo "Multi-Seed GORMPO-Diffusion Training: HalfCheetah-Medium-Expert"
echo "============================================"
echo ""
...
RESULTS_FILE="results/halfcheetah-medium-expert/diffusion/gormpo_diffusion_multiseed_results.csv"
...
for seed in "${seeds[@]}"; do
    ...
    python diffusion/ddim_training_unconditional.py \
        --config diffusion/configs/unconditional_training/halfcheetah_mlp_expert.yaml \
        --seed $seed \
        --epochs 100 \
        --out /public/gormpo/models/halfcheetah_medium_expert/diffusion_$seed
    ...
    python mopo.py \
        --config configs/diffusion/gormpo_halfcheetah_medium_expert.yaml \
        --seed $seed \
        --classifier_model_name /public/gormpo/models/halfcheetah_medium_expert/diffusion_$seed/checkpoint.pt \
        --epoch 1000 \
        --devid 6 \
