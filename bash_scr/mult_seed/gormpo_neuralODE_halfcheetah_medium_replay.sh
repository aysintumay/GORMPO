#!/bin/bash
# Multi-seed GORMPO-NeuralODE training for HalfCheetah-Medium-Replay-v2
# Usage: bash bash_scr/mult_seed/gormpo_neuralODE_halfcheetah_medium_replay.sh
...
echo "============================================"
echo "Multi-Seed GORMPO-NeuralODE Training: HalfCheetah-Medium-Replay"
echo "============================================"
echo ""
...
RESULTS_FILE="results/halfcheetah-medium-replay/neuralODE/gormpo_neuralODE_multiseed_results.csv"
...
for seed in "${seeds[@]}"; do
    ...
    python neuralODE/neural_ode_density.py \
        --config configs/neuralODE/halfcheetah_medium_replay_train.yaml \
        --seed $seed \
        --epochs 10 \
        --out /public/gormpo/models/halfcheetah_medium_replay/neuralODE_$seed
    ...
    python mopo.py \
        --config configs/neuralODE/halfcheetah_medium_replay.yaml \
        --seed $seed \
        --classifier_model_name /public/gormpo/models/halfcheetah_medium_replay/neuralODE_$seed \
        --epoch 1000 \
        --devid 0 \
