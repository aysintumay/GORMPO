#!/bin/bash
# Multi-seed GORMPO-RealNVP training for Hopper-Medium-Expert-v2
# Usage: bash bash_scr/mult_seed/gormpo_realnvp_hopper_medium_expert.sh
...
echo "============================================"
echo "Multi-Seed GORMPO-RealNVP Training: Hopper-Medium-Expert"
echo "============================================"
echo ""
...
RESULTS_FILE="results/hopper-medium-expert/realnvp/gormpo_realnvp_multiseed_results.csv"
...
for seed in "${seeds[@]}"; do
    ...
    python realnvp_module/realnvp.py \
        --config configs/realnvp/hopper_medium_expert.yaml \
        --seed $seed \
        --model_save_path /public/gormpo/models/hopper_medium_expert/realnvp_$seed \
        --device cuda:6
    ...
    python mopo.py \
        --config configs/realnvp/gormpo_hopper_medium_expert.yaml \
        --seed $seed \
        --classifier_model_name /public/gormpo/models/hopper_medium_expert/realnvp_$seed \
        --epoch 1000 \
        --devid 6 \
