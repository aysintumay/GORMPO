#!/bin/bash
# Multi-seed GORMPO-VAE training for Hopper-Medium-Expert-v2 (Sparse 72.5%)
# Usage: bash bash_scr/mult_seed/gormpo_vae_hopper_medium_expert_sparse3.sh

echo "============================================"
echo "Multi-Seed GORMPO-VAE Training: Hopper-Medium-Expert-Sparse3"
echo "============================================"
echo ""
...
RESULTS_FILE="results/hopper-medium-expert-v2_sparse_72.5/vae/gormpo_vae_multiseed_results.csv"
