#!/bin/bash
# Multi-seed GORMPO-NeuralODE training for Walker2d-Medium-Replay-v2
# Usage: bash bash_scr/mult_seed/gormpo_neuralODE_walker2d_medium_replay.sh
...
echo "============================================"
echo "Multi-Seed GORMPO-NeuralODE Training: Walker2d-Medium-Replay"
echo "============================================"
echo ""
...
RESULTS_FILE="results/walker2d-medium-replay/neuralODE/gormpo_neuralODE_multiseed_results.csv"
...
for seed in "${seeds[@]}"; do
    ...
    python mopo.py \
        --config configs/neuralODE/gormpo_walker2d_medium_replay.yaml \
