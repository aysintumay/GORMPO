#!/bin/bash
# Multi-seed GORMPO-NeuralODE training for HalfCheetah-Medium-Expert-v2
# Usage: bash bash_scr/mult_seed/gormpo_neuralODE_halfcheetah_medium_expert.sh
...
echo "============================================"
echo "Multi-Seed GORMPO-NeuralODE Training: HalfCheetah-Medium-Expert"
echo "============================================"
echo ""
...
RESULTS_FILE="results/halfcheetah-medium-expert/neuralODE/gormpo_neuralODE_multiseed_results.csv"
...
for seed in "${seeds[@]}"; do
    ...
    python neuralODE/neural_ode_density.py \
        --config configs/neuralODE/halfcheetah_medium_expert_train.yaml \
        --seed $seed \
        --epochs 10 \
        --out /public/gormpo/models/halfcheetah_medium_expert/neuralODE_$seed
    ...
    python mopo.py \
        ...
        --seed $seed \
        --classifier_model_name /public/gormpo/models/halfcheetah_medium_expert/neuralODE_$seed \
        --epoch 1000 \
        --devid 0 \
