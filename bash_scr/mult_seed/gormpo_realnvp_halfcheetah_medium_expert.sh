#!/bin/bash
# Multi-seed GORMPO-RealNVP training for HalfCheetah-Medium-Expert-v2
# Usage: bash bash_scr/mult_seed/gormpo_realnvp_halfcheetah_medium_expert.sh
...
echo "============================================"
echo "Multi-Seed GORMPO-RealNVP Training: HalfCheetah-Medium-Expert"
echo "============================================"
echo ""
...
RESULTS_FILE="results/halfcheetah-medium-expert/realnvp/gormpo_realnvp_multiseed_results.csv"
...
for seed in "${seeds[@]}"; do
    ...
    python mopo.py \
        --config configs/realnvp/gormpo_halfcheetah_medium_expert.yaml \
        --seed $seed \
