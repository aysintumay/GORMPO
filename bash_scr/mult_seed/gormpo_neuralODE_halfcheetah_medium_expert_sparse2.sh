#!/bin/bash
# Multi-seed GORMPO-NeuralODE training for HalfCheetah-Medium-Expert-v2 (Sparse 57.5%)
# Usage: bash bash_scr/mult_seed/gormpo_neuralODE_halfcheetah_medium_expert_sparse2.sh
...
echo "============================================"
echo "Multi-Seed GORMPO-NeuralODE Training: HalfCheetah-Medium-Expert-Sparse2"
echo "============================================"
echo ""
...
RESULTS_FILE="results/halfcheetah-medium-expert-v2_sparse_57.5/neuralODE/gormpo_neuralODE_multiseed_results.csv"
...
for seed in "${seeds[@]}"; do
    ...
    #     --config configs/neuralODE/halfcheetah_medium_expert_sparse_2_train.yaml \
    #     --seed $seed \
    #     --epochs 10 \
    #     --out /public/gormpo/models/halfcheetah_medium_expert_sparse_2/neuralODE_$seed
