#!/bin/bash
# Multi-seed GORMPO-Diffusion training for Hopper-Medium-Replay-v2
# Usage: bash bash_scr/mult_seed/gormpo_diffusion_hopper_medium_replay.sh
...
echo "============================================"
echo "Multi-Seed GORMPO-Diffusion Training: Hopper-Medium-Replay"
echo "============================================"
echo ""
...
RESULTS_FILE="results/hopper-medium-replay/diffusion/gormpo_diffusion_multiseed_results.csv"
...
for seed in "${seeds[@]}"; do
    ...
    python diffusion/ddim_training_unconditional.py \
        --config diffusion/configs/unconditional_training/hopper_mlp_replay.yaml \
        --seed $seed \
        --epochs 100 \
        --out /public/gormpo/models/hopper_medium_replay/diffusion_$seed
    ...
    python mopo.py \
        --config configs/diffusion/gormpo_hopper_medium_replay.yaml \
        --seed $seed \
        --classifier_model_name /public/gormpo/models/hopper_medium_replay/diffusion_$seed/checkpoint.pt \
        --epoch 1000 \
        --devid 6 \
