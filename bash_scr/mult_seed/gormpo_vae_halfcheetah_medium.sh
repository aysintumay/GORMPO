#!/bin/bash
# Multi-seed GORMPO-VAE training for HalfCheetah-Medium-v2
# Usage: bash bash_scr/mult_seed/gormpo_vae_halfcheetah_medium.sh
...
echo "============================================"
echo "Multi-Seed GORMPO-VAE Training: HalfCheetah-Medium"
echo "============================================"
echo ""
...
RESULTS_FILE="results/halfcheetah-medium/vae/gormpo_vae_multiseed_results.csv"
...
for seed in "${seeds[@]}"; do
    ...
    python vae_module/vae.py \
        --config configs/vae/halfcheetah.yaml \
        --seed $seed \
        --model_save_path /public/gormpo/models/halfcheetah_medium/vae_$seed \
        --device cuda:2
    ...
    python mopo.py \
        --config configs/vae/gormpo_halfcheetah.yaml \
        --seed $seed \
        --classifier_model_name /public/gormpo/models/halfcheetah_medium/vae_$seed \
        --epoch 1000 \
        --devid 2 \
