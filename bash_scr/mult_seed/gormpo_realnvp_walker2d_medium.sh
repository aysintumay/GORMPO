#!/bin/bash
# Multi-seed GORMPO-RealNVP training for Walker2d-Medium-v2
# Usage: bash bash_scr/mult_seed/gormpo_realnvp_walker2d_medium.sh
...
echo "============================================"
echo "Multi-Seed GORMPO-RealNVP Training: Walker2d-Medium"
echo "============================================"
echo ""
...
RESULTS_FILE="results/walker2d-medium/realnvp/gormpo_realnvp_multiseed_results.csv"
