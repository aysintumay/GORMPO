#!/bin/bash
# Multi-seed GORMPO-Diffusion training for Walker2d-Medium-Replay-v2
# Usage: bash bash_scr/mult_seed/gormpo_diffusion_walker2d_medium_replay.sh
...
echo "============================================"
echo "Multi-Seed GORMPO-Diffusion Training: Walker2d-Medium-Replay"
echo "============================================"
echo ""
...
RESULTS_FILE="results/walker2d-medium-replay/diffusion/gormpo_diffusion_multiseed_results.csv"
...
for seed in "${seeds[@]}"; do
    ...
    python diffusion/ddim_training_unconditional.py \
        --config diffusion/configs/unconditional_training/walker2d_mlp_replay.yaml \
        --seed $seed \
        --epochs 100 \
        --out /public/gormpo/models/walker2d_medium_replay/diffusion_$seed
    ...
    python mopo.py \
        --config configs/diffusion/gormpo_walker2d_medium_replay.yaml \
        --seed $seed \
        --classifier_model_name /public/gormpo/models/walker2d_medium_replay/diffusion_$seed/checkpoint.pt \
        --epoch 1000 \
        --devid 6 \
