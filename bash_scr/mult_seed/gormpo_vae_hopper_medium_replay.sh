#!/bin/bash
# Multi-seed GORMPO-VAE training for Hopper-Medium-Replay-v2
# Usage: bash bash_scr/mult_seed/gormpo_vae_hopper_medium_replay.sh
...
echo "============================================"
echo "Multi-Seed GORMPO-VAE Training: Hopper-Medium-Replay"
echo "============================================"
echo ""
...
RESULTS_FILE="results/hopper-medium-replay/vae/gormpo_vae_multiseed_results.csv"
...
for seed in "${seeds[@]}"; do
    ...
    python vae_module/vae.py \
        --config configs/vae/hopper_medium_replay.yaml \
        --seed $seed \
        --model_save_path /public/gormpo/models/hopper_medium_replay/vae_$seed \
        --device cuda:1
    ...
    python mopo.py \
        --config configs/vae/gormpo_hopper_medium_replay.yaml \
        --seed $seed \
        --classifier_model_name /public/gormpo/models/hopper_medium_replay/vae_$seed \
        --epoch 1000 \
        --devid 1 \
