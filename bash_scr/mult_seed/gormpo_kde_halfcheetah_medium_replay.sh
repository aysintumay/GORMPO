#!/bin/bash
# Multi-seed GORMPO-KDE training for HalfCheetah-Medium-Replay-v2
# Usage: bash bash_scr/mult_seed/gormpo_kde_halfcheetah_medium_replay.sh
...
echo "============================================"
echo "Multi-Seed GORMPO-KDE Training: HalfCheetah-Medium-Replay"
echo "============================================"
echo ""
...
for seed in "${seeds[@]}"; do
    ...
    python kde_module/kde.py \
        --config configs/kde/halfcheetah_medium_replay.yaml \
        --seed $seed \
        --save_path /public/gormpo/models/halfcheetah_medium_replay/kde_$seed \
        --devid 1
    ...
    python mopo.py \
        --config configs/kde/gormpo_halfcheetah_medium_replay.yaml \
        --seed $seed \
        --classifier_model_name /public/gormpo/models/halfcheetah_medium_replay/kde_$seed \
        --epoch 1000 \
        --devid 1 \
