#!/bin/bash
# Multi-seed GORMPO-RealNVP training for Walker2d-Medium-Replay-v2
# Usage: bash bash_scr/mult_seed/gormpo_realnvp_walker2d_medium_replay.sh
...
echo "============================================"
echo "Multi-Seed GORMPO-RealNVP Training: Walker2d-Medium-Replay"
echo "============================================"
echo ""
...
RESULTS_FILE="results/walker2d-medium-replay/realnvp/gormpo_realnvp_multiseed_results.csv"
...
for seed in "${seeds[@]}"; do
    ...
    python realnvp_module/realnvp.py \
        --config configs/realnvp/walker2d_medium_replay.yaml \
        --seed $seed \
        --model_save_path /public/gormpo/models/walker2d_medium_replay/realnvp_$seed \
        --device cuda:5
    ...
    python mopo.py \
        --config configs/realnvp/gormpo_walker2d_medium_replay.yaml \
        --seed $seed \
        --classifier_model_name /public/gormpo/models/walker2d_medium_replay/realnvp_$seed \
        --epoch 1000 \
        --devid 5 \
