#!/bin/bash
# Multi-seed GORMPO-NeuralODE training for HalfCheetah-Medium-v2
# Usage: bash bash_scr/mult_seed/gormpo_neuralODE_halfcheetah_medium.sh
...
echo "============================================"
echo "Multi-Seed GORMPO-NeuralODE Training: HalfCheetah-Medium"
echo "============================================"
echo ""
...
RESULTS_FILE="results/halfcheetah-medium/neuralODE/gormpo_neuralODE_multiseed_results.csv"
...
for seed in "${seeds[@]}"; do
    ...
    python neuralODE/neural_ode_density.py \
        --config configs/neuralODE/halfcheetah_train.yaml \
        --seed $seed \
        --epochs 10 \
        --out /public/gormpo/models/halfcheetah_medium/neuralODE_$seed
    ...
    python mopo.py \
        --config configs/neuralODE/halfcheetah_normal.yaml \
        --seed $seed \
        --classifier_model_name /public/gormpo/models/halfcheetah_medium/neuralODE_$seed \
        --epoch 1000 \
        --devid 0 \
