#!/bin/bash
# Multi-seed GORMPO-KDE training for HalfCheetah-Medium-Expert-v2
# Usage: bash bash_scr/mult_seed/gormpo_kde_halfcheetah_medium_expert.sh
...
echo "============================================"
echo "Multi-Seed GORMPO-KDE Training: HalfCheetah-Medium-Expert"
echo "============================================"
echo ""
...
RESULTS_FILE="results/halfcheetah-medium-expert/kde/gormpo_kde_multiseed_results.csv"
...
for seed in "${seeds[@]}"; do
    ...
    python kde_module/kde.py \
        --config configs/kde/halfcheetah_medium_expert.yaml \
        --seed $seed \
        --save_path /public/gormpo/models/halfcheetah_medium_expert/kde_$seed \
        --devid 1
    ...
    python mopo.py \
        ...
        --seed $seed \
        --classifier_model_name /public/gormpo/models/halfcheetah_medium_expert/kde_$seed \
        --epoch 1000 \
        --devid 1 \
