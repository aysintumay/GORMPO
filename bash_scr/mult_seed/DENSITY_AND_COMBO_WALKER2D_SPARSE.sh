#!/bin/bash
set -e
# COMBO + KDE density guardian on Walker2d-Medium-Expert (sparse).
#
# Mirrors DENSITY_AND_LEQ_WALKER2D.sh, but Step 3 optimises the policy with COMBO
...
#   bash bash_scr/mult_seed/DENSITY_AND_COMBO_WALKER2D_SPARSE.sh
#
# Env overrides:
...
# COMBO hypers (walker2d-medium-expert-v2: rollout-length=1, cql-weight=5.0)
...
echo "============================================"
echo "COMBO + KDE guardian: $TASK (sparse Walker2d)"
