#!/bin/bash
set -e
# COMBO + KDE density guardian on Hopper-Medium-Expert (sparse).
#
# Mirrors DENSITY_AND_LEQ_HOPPER.sh, but Step 3 optimises the policy with COMBO
...
#   bash bash_scr/mult_seed/DENSITY_AND_COMBO_HOPPER_SPARSE.sh
#
# Env overrides:
...
# COMBO hypers (hopper-medium-expert-v2: rollout-length=5, cql-weight=5.0)
...
echo "============================================"
echo "COMBO + KDE guardian: $TASK (sparse Hopper)"
