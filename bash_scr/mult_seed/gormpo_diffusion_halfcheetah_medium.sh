#!/bin/bash
# Multi-seed GORMPO-Diffusion training for HalfCheetah-Medium-v2
# Usage: bash bash_scr/mult_seed/gormpo_diffusion_halfcheetah_medium.sh
...
echo "============================================"
echo "Multi-Seed GORMPO-Diffusion Training: HalfCheetah-Medium"
echo "============================================"
echo ""
...
RESULTS_FILE="results/halfcheetah-medium/diffusion/gormpo_diffusion_multiseed_results.csv"
...
for seed in "${seeds[@]}"; do
    ...
    python diffusion/ddim_training_unconditional.py \
        --config diffusion/configs/unconditional_training/halfcheetah_mlp.yaml \
        --seed $seed \
        --epochs 100 \
        --out /public/gormpo/models/halfcheetah_medium/diffusion_$seed
    ...
    python mopo.py \
        ...
        --seed $seed \
        --classifier_model_name /public/gormpo/models/halfcheetah_medium/diffusion_$seed/checkpoint.pt \
        --epoch 1000 \
        --devid 6 \
