...
for seed in "${seeds[@]}"; do
    ...
    python diffusion/ddim_training_unconditional.py \
        ...
        --seed $seed \
        --epochs 100 \
        --out /public/gormpo/models/halfcheetah_medium_expert_sparse_2/diffusion_$seed
    ...
    python mopo.py \
        ...
        --seed $seed \
        --classifier_model_name /public/gormpo/models/halfcheetah_medium_expert_sparse_2/diffusion_$seed/checkpoint.pt \
        --epoch 1000 \
        --devid 6 \
