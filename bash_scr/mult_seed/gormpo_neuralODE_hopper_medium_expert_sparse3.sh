#!/bin/bash
# Multi-seed GORMPO-NeuralODE training for Hopper-Medium-Expert-v2 (Sparse 78%)
# Usage: bash bash_scr/mult_seed/gormpo_neuralODE_hopper_medium_expert_sparse3.sh
...
echo "============================================"
echo "Multi-Seed GORMPO-NeuralODE Training: Hopper-Medium-Expert-Sparse3"
echo "============================================"
echo ""
...
RESULTS_FILE="results/hopper-medium-expert-v2_sparse_78/neuralODE/gormpo_neuralODE_multiseed_results.csv"
...
for seed in "${seeds[@]}"; do
    ...
    python neuralODE/neural_ode_density.py \
        --config configs/neuralODE/hopper_medium_expert_sparse_3_train.yaml \
        --seed $seed \
        --epochs 10 \
        --out /public/gormpo/models/hopper_medium_expert_sparse_3/neuralODE_$seed
    ...
    python mopo.py \
        ...
        --seed $seed \
        --classifier_model_name /public/gormpo/models/hopper_medium_expert_sparse_3/neuralODE_$seed/model.pt \
        --epoch 1000 \
        --devid 0 \
