#!/bin/bash
# Multi-seed GORMPO-VAE training for HalfCheetah-Medium-Expert-v2
# Usage: bash bash_scr/mult_seed/gormpo_vae_halfcheetah_medium_expert.sh
...
echo "============================================"
echo "Multi-Seed GORMPO-VAE Training: HalfCheetah-Medium-Expert"
echo "============================================"
echo ""
...
RESULTS_FILE="results/halfcheetah-medium-expert/vae/gormpo_vae_multiseed_results.csv"
...
for seed in "${seeds[@]}"; do
    ...
    python vae_module/vae.py \
        --config configs/vae/halfcheetah_medium_expert.yaml \
        --seed $seed \
        --model_save_path /public/gormpo/models/halfcheetah_medium_expert/vae_$seed \
        --device cuda:2
    ...
    python mopo.py \
        --config configs/vae/gormpo_halfcheetah_medium_expert.yaml \
        --seed $seed \
        --classifier_model_name /public/gormpo/models/halfcheetah_medium_expert/vae_$seed \
        --epoch 1000 \
        --devid 2 \
