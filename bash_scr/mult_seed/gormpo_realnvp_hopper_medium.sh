#!/bin/bash
# Multi-seed GORMPO-RealNVP training for Hopper-Medium-v2
# Usage: bash bash_scr/mult_seed/gormpo_realnvp_hopper_medium.sh
...
echo "============================================"
echo "Multi-Seed GORMPO-RealNVP Training: Hopper-Medium"
echo "============================================"
echo ""
...
RESULTS_FILE="results/hopper-medium/realnvp/gormpo_realnvp_multiseed_results.csv"
...
for seed in "${seeds[@]}"; do
    ...
    python realnvp_module/realnvp.py \
        --config configs/realnvp/hopper_normal.yaml \
        --seed $seed \
        --model_save_path /public/gormpo/models/hopper_medium/realnvp_$seed \
        --device cuda:7
    ...
    python mopo.py \
        --config configs/realnvp/gormpo_hopper_linear_normal.yaml \
        --seed $seed \
        --classifier_model_name /public/gormpo/models/hopper_medium/realnvp_$seed \
        --epoch 1000 \
        --devid 7\
