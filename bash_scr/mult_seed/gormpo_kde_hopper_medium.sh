#!/bin/bash
# Multi-seed GORMPO-KDE training for Hopper-Medium-v2
# Usage: bash bash_scr/mult_seed/gormpo_kde_hopper_medium.sh
...
echo "============================================"
echo "Multi-Seed GORMPO-KDE Training: Hopper-Medium"
echo "============================================"
echo ""
...
RESULTS_FILE="results/hopper-medium/kde/gormpo_kde_multiseed_results.csv"
...
for seed in "${seeds[@]}"; do
    ...
    python kde_module/kde.py \
        --config configs/kde/hopper_medium.yaml \
        --seed $seed \
        --save_path /public/gormpo/models/hopper_medium/kde_$seed \
        --devid 3
    ...
    python mopo.py \
        ...
        --seed $seed \
        --classifier_model_name /public/gormpo/models/hopper_medium/kde_$seed \
        --epoch 1000 \
        --devid 3 \
