#!/bin/bash
# Multi-seed GORMPO-KDE training for Walker2d-Medium-v2
# Usage: bash bash_scr/mult_seed/gormpo_kde_walker2d_medium.sh
...
echo "============================================"
echo "Multi-Seed GORMPO-KDE Training: Walker2d-Medium"
echo "============================================"
echo ""
...
RESULTS_FILE="results/walker2d-medium/kde/gormpo_kde_multiseed_results.csv"
...
for seed in "${seeds[@]}"; do
    ...
    python kde_module/kde.py \
        --config configs/kde/walker2d_medium.yaml \
        --seed $seed \
        --save_path /public/gormpo/models/walker2d_medium/kde_$seed \
        --devid 1
    ...
    python mopo.py \
        ...
        --seed $seed \
        --classifier_model_name /public/gormpo/models/walker2d_medium/kde_$seed \
        --epoch 1000 \
        --devid 1 \
