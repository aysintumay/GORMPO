...
set -e  # Exit on error
echo "============================================"
echo "Training GORMPO with RealNVP on Hopper-Medium-Expert-v2 (Sparse 78%)"
echo "Testing multiple reward penalty coefficients"
echo "============================================"
echo ""
RESULTS_FILE="results/hyperparameter/hopper-medium-expert-sparse/gormpo_realnvp_multilambda_results.csv"
